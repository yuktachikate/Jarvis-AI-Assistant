...
PLACEHOLDER_PHRASE = "Just give me a sec."
...
INTRO_GREETING = (
    ...
    "I’ll transcribe every word, tackle your toughest questions (yes, even the impossible ones),  "
    "and generally keep things running smoothly.  "
    "Just say “Hey Jarvis” or “Hello Jarvis” and watch me spring into action.  "
...
CALL_OUTS = [
    "hey jarvis", "hello jarvis", "yo jarvis", "sup jarvis",
    "jarvis!", "ok jarvis", "psst jarvis"
]
...
# Pre-cache placeholder to avoid crackle
TTS_SAMPLE_RATE = tts_client.synthesizer.output_sample_rate
_placeholder_wav = tts_client.tts(PLACEHOLDER_PHRASE, speaker=MALE_SPEAKER)
...
def tts_worker():
    """
    Persistent output stream: write each synthesized wav to the same stream
    to eliminate open/close crackle. Convert list->ndarray to avoid attribute errors.
    """
